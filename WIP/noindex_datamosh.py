...
ffmpeg -y -i og.avi -vf scale=3840:2160:flags=neighbor -c:v libx264 -x264-params "keyint=0:minkeyint=0" -b:v 2117k -sc_threshold 0 -g 0 -me_method dia -an out2.avi 
